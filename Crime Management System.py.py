...
class Firstpage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        B3=tk.Button(back_grd,text='Open', bg='white', font=('Arial', 15), command=lambda:controller.show_frame(Thirdpage))
        B3.place(x=190, y=400)
